import { map, tileSource, mapLayer, currentLayerKey, setCurrentLayerKey, regionOverlaySource, resetLastRegionId, overlay, updateCoordsVal, registerCachedPMTiles } from './map';
import { updateNavmesh, getDungeonFloorKey, registerCachedNavmesh } from './navmesh';
import { updateMarkers, fetchMarkersData, npcsData, teleportsData, setRenderTeleports, renderTeleports } from './markers';
...
const ARCHIVE_KEYS = [
  'world',
  'navmesh_world',
  '32769_1', '32769_2', '32769_3', '32769_4',
  '32775', '32774', '32773', '32772', '32771', '32770',
  '32784', '32786', '32785'
];
